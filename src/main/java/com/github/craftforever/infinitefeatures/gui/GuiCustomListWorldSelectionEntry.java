...
public class GuiCustomListWorldSelectionEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public GuiCustomListWorldSelectionEntry(GuiCustomListWorldSelection guiCustomListWorldSelection, WorldSummary worldSummaryIn, ISaveFormat saveFormat)
    {
        ...
        if (this.client.gameSettings.touchscreen || isSelected)
        {
            ...
            if (this.worldSummary.markVersionInList())
            {
                ...
                if (this.worldSummary.askToOpenWorld())
                {
                    ...
                    if (j < 32)
                    {
                        this.customworldSelScreen.setVersionTooltip(TextFormatting.RED + I18n.format("selectWorld.tooltip.fromNewerVersion1") + "\n" + TextFormatting.RED + I18n.format("selectWorld.tooltip.fromNewerVersion2"));
                    }
                }
                else
                {
                    ...
                    if (j < 32)
                    {
                        this.customworldSelScreen.setVersionTooltip(TextFormatting.GOLD + I18n.format("selectWorld.tooltip.snapshot1") + "\n" + TextFormatting.GOLD + I18n.format("selectWorld.tooltip.snapshot2"));
                    }
                }
            }
            else
        ...
        if (this.worldSummary.askToOpenWorld())
        {
            this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
            {
                public void confirmClicked(boolean result, int id)
                {
                    ...
                    {
                        GuiCustomListWorldSelectionEntry.this.client.displayGuiScreen(GuiCustomListWorldSelectionEntry.this.customworldSelScreen);
                    }
                }
